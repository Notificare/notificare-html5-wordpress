...
== Upgrade Notice ==
= 1.10.0 =
* Updated to latest 1.10.0 SDK
= 1.7.0 =
* Removed public JS handling
* Add Service-Worker-Allowed header
* Parse integer values in config.js
= 1.6.3 =
* Small bugfixes
= 1.6.2 =
...
= 1.3.0 =
* Updated to latest 1.9.1 SDK with support for Chrome actions
* Minor bug fixes
= 1.2.0 =
* Updated to latest SDK that includes Do Not Disturb and User Data features
= 1.1.4 =
...
= 1.2.0 =
* Updated to latest 1.9.0 SDK

= 1.1.4 =
* Updated to latest 1.8.2 SDK

= 1.1.3 =
* Added unregister device method
* Fixes for push worker
